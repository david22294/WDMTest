...
)
{
    ...
    LARGE_INTEGER counter4 = KeQueryPerformanceCounter(&freq);
    LARGE_INTEGER counter5 = KeQueryPerformanceCounter(&freq);
    ...
    UNREFERENCED_PARAMETER(counter4);
    UNREFERENCED_PARAMETER(counter5);
